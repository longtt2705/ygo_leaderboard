...
import { getTierColor, formatElo, formatRecord, getTierFromElo } from "@/lib/utils";
...
export function TopPlayer({ player, localMap }: TopPlayerProps) {
    ...
    return (
        <Link href={`/player/${player.id}`}>
            <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-r ${getTierColor(getTierFromElo(player.lastSeasonElo || 0))} p-1 shadow-2xl cursor-pointer hover:scale-105 transition-transform duration-300`}>
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 p-4 sm:p-6 lg:p-8 text-white h-full w-full">
                    ...
                    <div className="relative z-10">
                        ...
                        {/* Player Info */}
                        <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 sm:pl-10">
                            ...
                            <div className="text-center sm:text-left sm:pl-12">
